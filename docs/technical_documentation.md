...
**Problem**: `Sprockets::FileNotFound` or asset not found
...
# Check for syntax errors in JS/CSS files
```

#### RuboCop Failures

**Problem**: Too many RuboCop offenses
...
# Show detailed offense information
...
rails generate migration AddIndexToTableColumn

# Use bullet gem to detect N+1 queries
# Add to Gemfile (development):
gem 'bullet'
